...
// COMPLTED (1) Use Android Studio's Activity wizard to create a new Activity called ChildActivity

// Do steps 2 - 5 in activity_child.xml
// COMPLTED (2) Change the ConstraintLayout to a FrameLayout and make appropriate adjustments
// COMPLTED (3) Give your TextView an ID of tv_display
// COMPLTED (4) Set the text to something that indicates this is default text being displayed
// COMPLTED (5) Make the text size a little larger

// Do steps 6 & 7 in ChildActivity.java
// COMPLTED (6) Create a TextView field to display your message
// COMPLTED (7) Get a reference to your TextView in Java