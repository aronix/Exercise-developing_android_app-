...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static int GITHUB_SEARCH_LOADER = 11;
    ...
    private void makeGithubSearchQuery() {
        ...
        if(githubQuery==null || TextUtils.isEmpty(githubQuery)) {
            mSearchResultsTextView.setText("there isn't anything to search for");
            return;
        }
        else {
    ...
    // COMPLTED (3) Override onCreateLoader
    ...
    public Loader<String> onCreateLoader(int id, final Bundle  args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                String ourQUERY = args.getString(SEARCH_QUERY_URL_EXTRA);
                String results;
                if(ourQUERY ==null || TextUtils.isEmpty(ourQUERY)) {
                    return null;
                }
                else {

                    try {
                        URL url = new URL(ourQUERY);
    ...
    // COMPLTED (11) If the URL is null or empty, return null

    // COMPLTED (12) Copy the try / catch block from the AsyncTask's doInBackground method
    // END - loadInBackground

    // COMPLTED (13) Override onLoadFinished
