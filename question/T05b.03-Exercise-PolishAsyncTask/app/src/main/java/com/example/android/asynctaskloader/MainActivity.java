...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onStart() {
        Log.d("◆◆◆DEBUG◆◆◆","onStart:enter");
        super.onStart();
    }

    @Override
    protected void onRestart() {
        Log.d("◆◆◆DEBUG◆◆◆","onRestart:enter");
        super.onRestart();
    }

    @Override
    protected void onStop() {
        Log.d("◆◆◆DEBUG◆◆◆","onStop:enter");
        super.onStop();
    }

    @Override
    protected void onDestroy() {
        Log.d("◆◆◆DEBUG◆◆◆","onDestroy:enter");
        super.onDestroy();
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.d("◆◆◆DEBUG◆◆◆","onCreate:enter");
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        Log.d("◆◆◆DEBUG◆◆◆","onCreateLoader:enter");
        return new AsyncTaskLoader<String>(this) {
            ...
            protected void onStartLoading() {
                Log.d("◆◆◆DEBUG◆◆◆","onStartLoading:enter");
            ...
            public String loadInBackground() {
                Log.d("◆◆◆DEBUG◆◆◆","doInBackground:enter");
    ...
    public void onLoadFinished(Loader<String> loader, String data) {
        Log.d("◆◆◆DEBUG◆◆◆","onLoadFinished:enter");
