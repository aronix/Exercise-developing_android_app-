...
public class MainActivity extends AppCompatActivity {
    ...
    static final String QUERY_URL_KEY="query_url";
    // COMPLETED (2) Create a static final key to store the search's raw JSON
    static final String RAW_JASON_KEY = "raw_jason";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(RAW_JASON_KEY));
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(RAW_JASON_KEY,mSearchResultsTextView.getText().toString());
